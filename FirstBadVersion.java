 ...
 * which will return whether version is bad. Implement a function 
 * to find the first bad version. You should minimize the number of 
 * calls to the API.
 */
...
public class Solution extends VersionControl {
    public int firstBadVersion(int n) {
		...
		int end = n;
		int last = 1;
		while (start <= end) { // start equal end only when the start can be larger
								// than end, be cautious to the endless loop
